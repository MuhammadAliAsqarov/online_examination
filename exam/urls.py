...
urlpatterns = [
    ...
    path('courses/<int:course_id>/enroll/', CourseViewSet.as_view({'post': 'enroll_students'})),
    ...
    path('tests/<int:test_id>/students/<int:student_id>/answers/', TestCompletionViewSet.as_view({'get': 'list'})),
    ...
    path('tests/<int:test_id>/statistics/', TestStatisticsViewSet.as_view({'get': 'retrieve'}))
]
